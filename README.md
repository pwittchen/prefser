...
| :ballot_box_with_check: | [`RxJava2.x`](https://github.com/pwittchen/prefser/tree/RxJava2.x) | `prefser-rx2` | [![Build Status for RxJava2.x](https://travis-ci.org/pwittchen/prefser.svg?branch=RxJava2.x)](https://travis-ci.org/pwittchen/prefser) | [![codecov](https://codecov.io/gh/pwittchen/prefser/branch/RxJava2.x/graph/badge.svg)](https://codecov.io/gh/pwittchen/prefser/branch/RxJava2.x) | ![Maven Central](https://img.shields.io/maven-central/v/com.github.pwittchen/prefser-rx2.svg?style=flat) |
...
You can also [read data from RxJava Observables](#subscribing-for-data-updates) in order to monitor single shared preference with a specified key.
