...
public class MainActivity extends Activity {
    ...
    @InjectView(R.id.value_one)
    protected EditText valueOne;
    @InjectView(R.id.value_two)
    protected EditText valueTwo;
    @InjectView(R.id.value_three)
    protected EditText valueThree;
