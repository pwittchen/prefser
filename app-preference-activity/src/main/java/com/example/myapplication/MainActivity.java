...
public class MainActivity extends Activity {
    ...
    @InjectView(R.id.app_updates)
    protected TextView tvApplicationUpdates;
    @InjectView(R.id.screen_on)
    protected TextView screenOn;
    @InjectView(R.id.download_type)
    protected TextView tvDownloadType;
    @InjectView(R.id.notification_type)
    protected TextView tvNotificationType;
    ...
    private void readNotificationType() {
        ...
        Set<String> notificationTypeValues = prefser.getPreferences().getStringSet("notification_type", defaultValues);
